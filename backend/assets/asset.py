...
from assets.exchanges_mappings.bittrex import WORLD_TO_BITTREX
# from assets.resolver import AssetResolver
from constants.misc import NFT_DIRECTIVE
from constants.resolver import ChainID, evm_address_to_identifier
from errors.asset import UnknownAsset, UnsupportedAsset, WrongAssetType
from errors.serialization import DeserializationError
from fval import FVal
from types import ChecksumEvmAddress, EvmTokenKind, Timestamp
...
class Asset:
    ...
    def check_existence(self, query_packaged_db: bool = True) -> 'Asset':
        normalized_id = AssetResolver().check_existence(self.identifier,
                                                        query_packaged_db=query_packaged_db)  # noqa: E501
